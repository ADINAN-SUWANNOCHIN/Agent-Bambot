...
- **Aliases users may say:** กลุ่มประนอม, กลุ่ม 01, group 01
- **Meaning:** Debtor is actively cooperating under a restructured repayment plan
- **IMPORTANT:** Do NOT use this group filter when the question is about TDR status. "ประนอมหนี้" / "อยู่ระหว่างการประนอมหนี้" → use `สถานะการประนอมหนี้ == 'TDR'`, not this group.
