...
- **A** — Prime quality: excellent location, high liquidity, marketable quickly at full appraised value. Minimal uncertainty. Provision ~0–1%.
- **B** — Good quality: acceptable location and condition, marketable within reasonable timeframe (6–12 months). Small discount risk. Provision ~20–25%.
- **C** — Fair quality: limited marketability due to location, legal encumbrances, condition, or oversupply in local market. Expect 20–40% discount to appraised value at auction. Provision ~50–75%.
- **D** — Poor quality: highly illiquid, distressed condition, disputed title, remote location, or severely encumbered. Auction proceeds may be 50%+ below appraised value. Provision ~100%.
...
- **Write-off timeline:** Grade D assets are typically written off within 1–2 years of classification

---

## BOT Asset Classification (5 Categories by Days Overdue)

The Bank of Thailand classifies loans along a 5-step scale before reaching NPL status:

| Category | Thai | Days Overdue | Action |
|----------|------|--------------|--------|
| Pass (ปกติ) | ปกติ | Current | No action |
| Special Mention | การดำเนินการพิเศษ | 1–90 days | Monitoring; preemptive TDR opportunity window |
| Substandard | ต่ำกว่ามาตรฐาน | 90–180 days | NPL classification begins; TDR offer required |
| Doubtful | สงสัยจะสูญ | 180–360 days | Significant loss expected |
| Loss | ขาดทุน/หนี้สูญ | >360 days | Full provision; write-off candidate |

**Key threshold:** 90 days past due = NPL trigger (Substandard or worse).  
**Preemptive restructuring** offered at Special Mention stage (before 90 days) avoids NPL classification entirely — most favorable for all parties.  
Maps to TFRS 9: Pass/Special Mention → Stage 1/2; Substandard/Doubtful/Loss → Stage 3 (NPL).
...
- **Cash received column (NPL collection table):** `เงินรับประเภท CASH สะสมในเดือน YTD`
- **LGO1 received column (NPL collection table):** `เงินรับประเภท LGO1 สะสมในเดือน YTD`
  - LGO1 = court-enforced collection via กรมบังคับคดี (Legal Execution Department)
- **Total received:** `df['เงินรับประเภท CASH สะสมในเดือน YTD'] + df['เงินรับประเภท LGO1 สะสมในเดือน YTD']`
- **Debtors with zero cash:** `df[df['เงินรับประเภท CASH สะสมในเดือน YTD'] == 0]` — no voluntary payment at all
...
- **NPA collection columns:** `Full Payment`, `Installment Payment`, `Others (ค่าเช่า, ริบเงิน, ดอกเบี้ย)`, `Total Actual`
